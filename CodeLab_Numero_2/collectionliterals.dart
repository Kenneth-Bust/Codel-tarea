...
void main() {
  ...
  // Comprobaciones para aListOfStrings
  ...
  // Comprobaciones para aSetOfInts
  ...
  // Comprobaciones para aMapOfStringsToInts
  ...
  // Comprobaciones para anEmptyListOfDouble
  ...
  // Comprobaciones para anEmptySetOfString
  ...
  // Comprobaciones para anEmptyMapOfDoublesToInts
  ...
  // Verificación de errores y resultados
  if (errs.isEmpty) {
    print('Success!');
  } else {
    errs.forEach(print);
