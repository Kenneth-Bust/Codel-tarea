...
void main() {
  ...
  try {
    // Ejecuta tryFunction con una función que arroja una excepción genérica
  ...
  try {
    // Ejecuta tryFunction con una función que arroja una excepción con mensaje
  ...
  try {
    // Ejecuta tryFunction con una función que arroja una cadena
  ...
  try {
    // Ejecuta tryFunction con una función que no arroja excepciones
    tryFunction(() {}, logger);
